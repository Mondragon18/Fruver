		...
		<div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-info-dark">
                    <h3 class="block-title"><i class="fa fa-plus"></i> Modificar datos de la categoria</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-6">
						 ...
						 <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" name="genero" id="generou" class="form-control" style="width: 100%;">
						...
						<div class="col-lg-12 col-xl-12">
							<div class="form-group">
								...
								<textarea class="form-control" name="descripcion" id="descripcionu" cols="10" rows="5"></textarea>
							</div>
						</div>
                    </div>
