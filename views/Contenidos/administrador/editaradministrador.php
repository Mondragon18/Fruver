<div class="modal fade" id="editaradministrador" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="identificacionu" id="identificacionu">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nombresu" id="nombresu">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="apellidou" id="apellidou">
                                </div>
                            </div>
                        </div>
                        <!-- <div class="col-lg-6 col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="email" id="correou" name="correou">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" id="claveu1" name="claveu1">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="password" id="claveu2" name="claveu2">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <select name="privilegiou" id="privilegiou"  class="form-control" style="width: 100%;">
                                    <option>--- Seleccione el privilegio ---</option>
                                    <?php 
