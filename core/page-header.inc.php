<header id="page-header" class="page-header-dark">
    <!-- Header Content -->
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block ml-2">
                <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded" src="<?php echo RUTA_MEDIA;?>avatars/avatar10.jpg" alt="Header Avatar" style="width: 18px;">
                    <span class="d-none d-sm-inline-block ml-1">
                        <?php 
                            echo $_SESSION['nombre_cms'] . " " . $_SESSION['apellido_cms'] ;
                        ?>
                    </span>
                ...
                <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                    <div class="p-3 text-center bg-primary">
                        <img class="rounded" src="<?php echo RUTA_MEDIA;?>avatars/avatar10.jpg" alt="Header Avatar" style="width: 48px;">
                    </div>
                    <div class="p-2">
                        ...
                        <a class="btn-exit-system dropdown-item d-flex align-items-center justify-content-between" id="btn-exit-system">                    
                            <span>Salir</span>
